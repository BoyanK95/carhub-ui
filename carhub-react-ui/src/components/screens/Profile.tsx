...
const savedCars = [
  { id: 1, name: "Tesla Model S", image: "/placeholder.svg?height=100&width=150" },
  { id: 2, name: "Porsche 911", image: "/placeholder.svg?height=100&width=150" },
  { id: 3, name: "Ford Mustang GT", image: "/placeholder.svg?height=100&width=150" },
]
              ...
              <TabsContent value="notifications">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <label htmlFor="newCars">New cars matching your preferences</label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <input type="checkbox" id="priceDrops" className="form-checkbox" />
